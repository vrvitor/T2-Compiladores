...
public class LuazinhaParser extends Parser {
	...
	public static class ComandoContext extends ParserRuleContext {
		...
		public Token n;
		public Token for2;
		public ListadenomesContext ln1;
		public BlocoContext bl;
		public NomedafuncaoContext ndf;
		public ListadenomesContext ln2;
	...
	public final ComandoContext comando() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				setState(108);
				((ComandoContext)_localctx).n = match(NOME);
				setState(109);
				match(T__1);
				setState(110);
				exp(0);
			...
			case 8:
				...
				setState(122);
				((ComandoContext)_localctx).ln1 = listadenomes();
				setState(123);
				match(T__13);
				setState(124);
				listaexp();
				...
				match(T__2);
				setState(126);
				((ComandoContext)_localctx).bl = bloco();
				setState(127);
				match(T__3);
				}
				break;
			case 9:
				...
				match(T__14);
				setState(130);
				((ComandoContext)_localctx).ndf = nomedafuncao();
				setState(131);
				corpodafuncao();
				}
				break;
			...
			case 11:
				...
				match(T__15);
				setState(138);
				((ComandoContext)_localctx).ln2 = listadenomes();
				setState(141);
				_la = _input.LA(1);
				if (_la==T__1) {
					{
	...
	public static final String _serializedATN =
		...
		"\26\30\32\34\36 \"$&(*,.\60\2\5\4\2\3\3\17\17\3\2!/\4\2\"\"\60\61\u0168"+
